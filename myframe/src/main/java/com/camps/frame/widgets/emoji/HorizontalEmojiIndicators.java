package com.camps.frame.widgets.emoji;
...
import com.camps.frame.widgets.emoji.beans.EmojiIndicatorInfo;
import com.camps.frame.widgets.emoji.beans.EmojiPanelBean;
...
public class HorizontalEmojiIndicators extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private LinearLayout createIndicatorParentView(boolean isInnerIndicator) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DisplayUtils.dp2px(getContext(),44f));
        if (isInnerIndicator) {
    ...
    private ImageView createInnerImageView(int index) {
        ...
        LinearLayout.LayoutParams layoutParams = new LayoutParams(DisplayUtils.dp2px(getContext(), 6f), DisplayUtils.dp2px(getContext(), 6f));
        layoutParams.leftMargin = DisplayUtils.dp2px(getContext(), 4f);
        layoutParams.rightMargin = DisplayUtils.dp2px(getContext(), 4f);
    ...
    private ImageView createOutImageView(int index) {
        ImageView imageView = new ImageView(getContext());
        LinearLayout.LayoutParams layoutParams = new LayoutParams(DisplayUtils.dp2px(getContext(),60), DisplayUtils.dp2px(getContext(), 48f));
        imageView.setLayoutParams(layoutParams);
        ...
        int padding = DisplayUtils.dp2px(getContext(), 8f);
