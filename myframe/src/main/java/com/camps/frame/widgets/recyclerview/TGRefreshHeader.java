...
public class TGRefreshHeader extends LinearLayout implements BaseRefreshHeader
{
    ...
    {
        mContainer = (LinearLayout)findViewById(R.id.tiger_refresh_header_layout);
        LayoutParams layoutParams = (LayoutParams)mContainer.getLayoutParams();
        layoutParams.width = LayoutParams.MATCH_PARENT;
        layoutParams.height = 0;
        mContainer.setLayoutParams(layoutParams);

        mHeaderArrowIv = (ImageView) findViewById(R.id.tiger_iv_default_refresh_header_arrow);
        mHeaderChrysanthemumIv = (ImageView) findViewById(R.id.tiger_iv_default_refresh_header_chrysanthemum);
