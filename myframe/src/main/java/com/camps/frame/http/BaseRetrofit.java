...
{
    private static final Logger LOG = Logger.getLogger(BaseRetrofit.class);
    ...
    protected static Request appendParams(Request originalRequest, Map<String, String> params)
    {
        if(originalRequest.method().equalsIgnoreCase("GET"))
        {
            ...
            LOG.d("[Method:appendParams] method = " + originalRequest.method() + " ; url = " + url);
        ...
        else if(originalRequest.method().equals("POST"))
        {
            ...
            if(requestBody instanceof FormBody)
            {
                ...
                LOG.d("[Method:appendParams] method = " + originalRequest.method() + " ; url = " + originalRequest.url() + " ; params : " + stringify(newFormBody));
        ...
        {
            LOG.d("[Method:appendParams] method = " + originalRequest.method() + " ; url = " + originalRequest.url());
        }
