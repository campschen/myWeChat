...
import com.camps.frame.widgets.span.TextClickSpan;
import com.camps.frame.widgets.span.VerticalImageSpan;
            ...
            if (start >= 0 && end > 0 && start < end) {
                if (spanStr.startsWith(Constants.SCHEME_EMOJI)) {
                    ...
                    spannableStringBuilder.setSpan(
                            new VerticalImageSpan(context, getEmojiDrawable(context, emojiName, textView)), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                } else {
