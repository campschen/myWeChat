...
import com.camps.frame.others.SimpleWeakObjectPool;
...
import com.camps.homework.beans.CommentBean;
import com.camps.frame.widgets.span.TextMovementMethod;
...
public class VerticalCommentWidget extends LinearLayout implements ViewGroup.OnHierarchyChangeListener, OnItemClickPopupMenuListener {
    ...
    private void init() {
        mCommentVerticalSpace = DisplayUtils.dp2px(getContext(),3f);
