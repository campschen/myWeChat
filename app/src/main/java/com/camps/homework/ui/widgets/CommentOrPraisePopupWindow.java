...
public class CommentOrPraisePopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public CommentOrPraisePopupWindow(Context context) {
        ...
        this.mPopupWindowHeight = DisplayUtils.dp2px(context, 38);
        this.mPopupWindowWidth = DisplayUtils.dp2px(context, 190);
    ...
    public void showPopupWindow(View anchor) {
        ...
        int xOffset = location[0] - mPopupWindowWidth - DisplayUtils.dp2px(MomentsApplication.getContext(), 10f);
